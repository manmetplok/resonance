...
pub use derive::{
    ...
    generate_lyrics, motif_intervals, phrase_grammar_roles, toggle_manual_motif_cell,
    ...
    ManualMotifCell, ManualMotifNote, MelodyParams, MelodyStyle, MotifParams, MotifSource,
    PadParams,
    PhraseGrammarRole, RhythmHit,
...
pub use generator::{
    ...
    MarkovTable, SchemaKind, TableRegistry,
};
