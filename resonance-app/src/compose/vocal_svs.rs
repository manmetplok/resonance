...
/// Render the vocal clip. `lyrics` is a per-note annotation slice
...
/// syllable" mode and is what the engine sees for non-vocal clips
/// rendered through the same code path during testing.
