---
name: ba-dev-resonance-plugin
description: "Developer resonance-plugin (resonance-plugin): implements only todos for the components/subcomponents assigned to it, using its skills. Watches ba for approved, unblocked work. Built to run on a loop."
---
