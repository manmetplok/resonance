//! Shared palette. Matches the mastering / compressor / wavetable plugins
//! so every Resonance plugin feels like one product. The one reverb-specific
//! extension is `TAIL_GLOW`, a translucent accent used to fill the analytic
//! decay polygon in the impulse view.
