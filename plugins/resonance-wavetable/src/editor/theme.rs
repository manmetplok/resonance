...
//!
//! Palette and shape tokens mirror the `Resonance Wavetable` design handoff:
//! a lavender accent (`#8b6dff`) for primary controls, warm amber
//! (`#e8c47b`) for modulation/position indicators, plus state LEDs
...
// The viz/* modules reference these older names.
